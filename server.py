...
class Server:
    ...
    def start_interpreter(self):
        ...
        while True:
            ...
            if re.search(r"help\w*", command):
                ...
                print(tabulate.tabulate([["Command", "Usage"], ["help", "Print this help message", ],
    ...
    def receive_all_data(self, socket, buffer_size):
        """Function responsible for calling socket.recv() repeatedly until no data is to be received"""
        data = b""
        while True:
