...
try:
    ...
    # for some machines that do not have display (i.e., cloud Linux machines)
...
class Client:
    ...
    def handle_command(self, command):
        ...
        if command.lower() in ["exit", "quit"]:
            ...
            if pyautogui_imported:
                ...
                output = "Display is not supported on this machine."
    ...
    def get_sys_hardware_info(cls):
        ...
        output += tabulate(list_gpus, headers=("id", "name", "load", "free memory", "used memory",
